...
for (let i = 0; i < count; i++) {
  List.push(Mock.mock({
    ...
    'manageUnit|1': ['阳春街道办', '临海管理处', '朝阳街道办'],
    people: '@natural( 100, 300 )',
    temperature: '@natural( 10, 30 )',
    smell: '@natural( 20, 100 )',
    nkwh: '@natural( 4, 30 )',
    kengwei: '@natural( 10, 30 )',
    water: '@natural( 10, 30 )',
    company: ['浙江敏杰清洁公司', '江苏棉结清洁公司']
  }))
}
