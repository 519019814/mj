<template>
  <div class="inline-edit-container">
    ...
    >
      ...
      <el-table-column label="行政区划" width="150px">
        <template slot-scope="{ row }">
      ...
      <el-table-column label="人流量" width="90px" sortable="custom" prop="people">
        <template slot-scope="{ row }">
          <span>{{ row.people }}</span>
        </template>
      </el-table-column>
      <el-table-column label="公厕面积" width="150px" align="center">
        <template slot-scope="{ row }">
          <span>{{ row.floorage }}m<sup>2</sup></span>
        </template>
      </el-table-column>
      <el-table-column label="坑位数量" width="150px" align="center" sortable="custom" prop="floorage">
        <template slot-scope="{ row }">
          <span>{{ row.floorage }}</span>
        </template>
      </el-table-column>
